...
type CreateAtomicSwapRequestOp struct {
	Key
	Attributes    *CreateAtomicSwapRequestOpAttributes    `json:"attributes,omitempty"`
	Relationships *CreateAtomicSwapRequestOpRelationships `json:"relationships,omitempty"`
}
