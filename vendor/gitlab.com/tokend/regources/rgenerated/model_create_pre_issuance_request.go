...
type CreatePreIssuanceRequest struct {
	Key
	Attributes    *CreatePreIssuanceRequestAttributes    `json:"attributes,omitempty"`
	Relationships *CreatePreIssuanceRequestRelationships `json:"relationships,omitempty"`
}
