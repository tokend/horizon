...
type CreateAmlAlertRequest struct {
	Key
	Attributes    *CreateAmlAlertRequestAttributes    `json:"attributes,omitempty"`
	Relationships *CreateAmlAlertRequestRelationships `json:"relationships,omitempty"`
}
...
type CreateAmlAlertRequestsResponse struct {
	Data     []CreateAmlAlertRequest `json:"data"`
	Included Included                `json:"included"`
