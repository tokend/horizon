...
type CreateSaleRequestOp struct {
	Key
	Attributes    *CreateSaleRequestOpAttributes    `json:"attributes,omitempty"`
	Relationships *CreateSaleRequestOpRelationships `json:"relationships,omitempty"`
}
...
type CreateSaleRequestOpsResponse struct {
	Data     []CreateSaleRequestOp `json:"data"`
	Included Included              `json:"included"`
