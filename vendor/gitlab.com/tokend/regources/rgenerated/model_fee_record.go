...
type FeeRecord struct {
	Key
	Attributes    *FeeRecordAttributes    `json:"attributes,omitempty"`
	Relationships *FeeRecordRelationships `json:"relationships,omitempty"`
}
...
type FeeRecordsResponse struct {
	Data     []FeeRecord `json:"data"`
	Included Included    `json:"included"`
