...
type CreateSaleRequest struct {
	Key
	Attributes    *CreateSaleRequestAttributes    `json:"attributes,omitempty"`
	Relationships *CreateSaleRequestRelationships `json:"relationships,omitempty"`
}
...
type CreateSaleRequestsResponse struct {
	Data     []CreateSaleRequest `json:"data"`
	Included Included            `json:"included"`
