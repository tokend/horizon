...
type CreateWithdrawRequestOp struct {
	Key
	Attributes    *CreateWithdrawRequestOpAttributes    `json:"attributes,omitempty"`
	Relationships *CreateWithdrawRequestOpRelationships `json:"relationships,omitempty"`
}
...
type CreateWithdrawRequestOpsResponse struct {
	Data     []CreateWithdrawRequestOp `json:"data"`
	Included Included                  `json:"included"`
