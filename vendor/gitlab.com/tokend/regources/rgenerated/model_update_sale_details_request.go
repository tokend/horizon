...
type UpdateSaleDetailsRequest struct {
	Key
	Attributes    *UpdateSaleDetailsRequestAttributes    `json:"attributes,omitempty"`
	Relationships *UpdateSaleDetailsRequestRelationships `json:"relationships,omitempty"`
}
