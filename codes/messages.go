...
var messages = map[string]string{
	...
	"op_atomic_swap_ask_owner_full_line":                "Seller balance amount exceed max amount",
	...
	"op_source_account_equals_bid_owner":                "Cannot create atomic swap request for own bid",
