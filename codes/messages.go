...
var messages = map[string]string{
	...
	"op_no_balance":                                     "There is no balance with such id, which is specified in operation",
	"op_no_asset":                                       "There is no asset with such asset code, which is specified in operation",
	"op_not_supported":                                  "Such operation currently is not supported",
	"op_no_bid":                                         "There is no atomic swap bid with such bid id",
	"op_no_sale":                                        "There is no sale with such id, which is specified in operation",
