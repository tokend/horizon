...
var messages = map[string]string{
	...
	"op_asset_expired":                                   "Asset expired",
	"op_base_asset_expired":                              "Base asset expired",
	"op_quote_asset_expired":                             "Quote asset expired",
	"op_invalid_investment_token":                        "Investment token is expired or related investment token sale doesn't exist",
	"op_changing_investment_token_policy_is_not_allowed": "Changing 'INVESTMENT_TOKEN' policy is not allowed",
	"op_review_details_must_be_provided":                 "Review details must be provided for review of the request with such type",
	...
	"op_withdrawal_tasks_not_found":                      "There is no key value entry with withdraw tasks key",
	"op_not_allowed_to_set_withdrawal_tasks":             "Not allowed to set all tasks now",
	"op_removing_not_set_tasks":                          "Not allowed to remove not exists task",
	"op_incompatible_policies":                           "Not allowed to set WITHDRAWABLE_V2 policy with WITHDRAWABLE or TWO_STEP_WITHDRAWAL",
}
