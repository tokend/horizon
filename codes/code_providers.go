...
var codeProviders = map[xdr.OperationType]codeProvider{
	...
	xdr.OperationTypeCreateManageOfferRequest:    func(ir xdr.OperationResultTr) shortStr { return ir.MustCreateManageOfferRequestResult().Code },
	xdr.OperationTypeCreatePaymentRequest:        func(ir xdr.OperationResultTr) shortStr { return ir.MustCreatePaymentRequestResult().Code },
	...
	xdr.OperationTypeCreateDeferredPaymentCreationRequest: func(ir xdr.OperationResultTr) shortStr {
		return ir.MustCreateDeferredPaymentCreationRequestResult().Code
	},
	xdr.OperationTypeCancelDeferredPaymentCreationRequest: func(ir xdr.OperationResultTr) shortStr {
		return ir.MustCancelDeferredPaymentCreationRequestResult().Code
	},
