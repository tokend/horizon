...
var codeProviders = map[xdr.OperationType]codeProvider{
	...
	xdr.OperationTypeCreateDeferredPaymentCreationRequest: func(ir xdr.OperationResultTr) shortStr { return ir.MustCreateDeferredPaymentCreationRequestResult().Code },
