...
var codeProviders = map[xdr.OperationType]codeProvider{
	...
	xdr.OperationTypeCreateAtomicSwapBidRequest:  func(ir xdr.OperationResultTr) shortStr { return ir.MustCreateAtomicSwapBidCreationRequestResult().Code },
	xdr.OperationTypeCancelAtomicSwapBid:         func(ir xdr.OperationResultTr) shortStr { return ir.MustCancelAtomicSwapBidResult().Code },
	xdr.OperationTypeCreateAtomicSwapRequest:     func(ir xdr.OperationResultTr) shortStr { return ir.MustCreateAtomicSwapRequestResult().Code },
