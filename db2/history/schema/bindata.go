...
func migrations019_add_timestamps_2_reviewable_reqSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/019_add_timestamps_2_reviewable_req.sql", size: 327, mode: os.FileMode(420), modTime: time.Unix(1514389472, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func migrations020_alter_sales_detailsSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/020_alter_sales_details.sql", size: 162, mode: os.FileMode(420), modTime: time.Unix(1514560374, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
