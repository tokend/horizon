...
const (
	...
	// IncludeTypeOrderBookV4BaseAsset - defines if base asset should be included in the response
	IncludeTypeOrderBookV4BaseAsset = "base_asset"
	// IncludeTypeOrderBookV4QuoteAsset - defines if quote asset should be included in the response
	IncludeTypeOrderBookV4QuoteAsset = "quote_asset"
)

var includeTypeOrderBookV4All = map[string]struct{}{
	IncludeTypeOrderBookV4BuyEntries:  {},
	IncludeTypeOrderBookV4SellEntries: {},
	IncludeTypeOrderBookV4BaseAsset:   {},
	IncludeTypeOrderBookV4QuoteAsset:  {},
}
