...
func (h *getOrderBookHandler) GetOrderBook(request *requests.GetOrderBook) (*rgenerated.OrderBookEntrysResponse, error) {
	...
	response := &rgenerated.OrderBookEntrysResponse{
		Data:  make([]rgenerated.OrderBookEntry, 0, len(coreOrderBookEntries)),
