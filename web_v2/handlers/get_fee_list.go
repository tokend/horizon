...
func (h *getFeeListHandler) GetFeeList(request *requests.GetFeeList) (*rgenerated.FeeRecordsResponse, error) {
	...
	response := &rgenerated.FeeRecordsResponse{
		Data:  make([]rgenerated.FeeRecord, 0, len(fees)),
